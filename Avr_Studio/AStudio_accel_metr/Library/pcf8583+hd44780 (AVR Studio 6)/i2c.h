//------------------Библиотека для работы с i2c шиной----------------------------------
//               работает программно
//  подключается к любым свободным пинам одного порта
//      ==== автор Шутов Максим [Zlodey], г.Вельск, Ноябрь 2013 ====
//          ===============версия 10-11-2013===================
// в планах реализовать контроль линии SCL для определения занятости SLAVE устройства
//-------------------------------------------------------------------------------------
