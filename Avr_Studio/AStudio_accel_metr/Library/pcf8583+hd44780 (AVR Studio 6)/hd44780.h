...
#define HD44780_CONFIG_DATA_PORT_NAME		A	// Буква порта к которому подключена шина данных (D0-D7)
...
#define HD44780_CONFIG_D3_PIN				3	// D3 (Если 4 битный режим то указывать не нужно)
...
#define HD44780_CONFIG_RS_PIN				5	// RS
#define HD44780_CONFIG_RW_PIN				6	// RW
#define HD44780_CONFIG_E_PIN				7	// E

#define HD44780_CONFIG_PINMODE				0	// Если контакты дата шины подключены вразнобой, установите тут 1
...
#define HD44780_CONFIG_LINES				1	// Сколько строк поддерживается. (0 - одна / 1 - 2 и более)
...
#define HD44780_CONFIG_PAUSE_INIT_STEPONE			4100  // Пауза между первой и второй командами инициализации (в документации 
														  // сказано минимум 4.1ms)

#define HD44780_CONFIG_PAUSE_INIT_STEPTWO			100   // Пауза между второй и третьей командами инициализации (в документации 
														  // сказано минимум 100us)

#define HD44780_CONFIG_PAUSE_INIT_STEPTHREE			100   // Пауза между третьей и четверой командами инициализации (в документации 
														  // сказано минимум 100us)
